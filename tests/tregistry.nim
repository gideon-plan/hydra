...
suite "URL parsing":
  ...
  test "parse valkey URL":
    ...
    check ep.scheme == SpScheme.Valkey
    check ep.host == "redis"
    check ep.port == 6379
  ...
  test "parse 9p URL":
    ...
    check ep.scheme == SpScheme.Ninep
    check ep.host == "host"
    check ep.port == 564
